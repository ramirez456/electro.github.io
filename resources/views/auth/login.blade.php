...
<html lang="en">
<head>
	<title>ELECTROCENTRO - HUÁNUCO</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  method="POST" action="{{ route('login') }}">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" id="mail" value="{{ old('email') }}" required autofocus placeholder="Email">
...
<!--===============================================================================================-->
	<script src="libs/tilt/tilt.jquery.min.js"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
